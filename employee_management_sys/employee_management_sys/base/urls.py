...
from employee_management_sys.base.views import IndexView, UserEditView, UserDeleteView, UserCreateView
...
urlpatterns = [
    ...
    path('reset-password', auth_views.PasswordChangeView.as_view(success_url=reverse_lazy('index')),
         name='reset password'),
    path('login', auth_views.LoginView.as_view(template_name='login.html', success_url=reverse_lazy('index'),
